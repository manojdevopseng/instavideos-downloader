      ...
      <div className="mx-auto mb-12 mt-8 flex w-full max-w-3xl flex-col gap-8 px-2 text-sm md:px-4 md:text-base">
        <section id="logo">
          <div className="flex w-full items-center justify-center gap-4">
            <Image
              ...
              height={300}
              alt="logo"
              className="h-32 w-32 md:h-40 md:w-40 mr-11"
            />
            <div
              aria-label="Logo"
              className={cn(
        ...
        <section id="welcome">
          ...
          <p className="leading-7 text-justify">
            Greetings to Instagram Video Downloader! Explore Instagram videos in a whole new way with our platform. Our intuitive interface enables you to easily preserve your preferred Instagram videos, providing the flexibility to enjoy them offline. Count on us for high-quality downloads, speed, and reliability, fulfilling all your video downloading requirements. Navigate through our user-friendly interface and initiate the creation of your personal offline compilation of Instagram content. Dive into the realm of Instagram videos effortlessly and conveniently, all in one place!
          </p>
        </section>
        ...
        <section id="features">
          ...
          <ul className="ml-6 flex list-disc flex-col gap-1 leading-7 text-justify">
        ...
        <section id="instructions text-justify">
